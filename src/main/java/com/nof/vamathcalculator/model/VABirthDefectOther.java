...
public class VABirthDefectOther implements VAMathBirthDefectChild {
    ...
    private final List<Double> compensation_list = Arrays.asList(169.00, 362.00, 1231.00, 2096.00);

    VABirthDefectOther(Integer level, String short_name) {
        if(level >= MIN_LEVEL && level <= MAX_LEVEL) {
            ...
            throw new IllegalStateException("Non Spina Bifida birth defects are rated from levels 1 to 4. Invalid level given!");
        }
    }
    @Override
