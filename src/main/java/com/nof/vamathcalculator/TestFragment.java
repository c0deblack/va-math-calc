...
public class TestFragment extends Fragment {
    ...
    /**
     * Used to get the value to sent to the TestFragment
     * Key used in the intent passed from LoadingFullScreenActivity.
     */
    public static final String TEST_VIEW_DATA = "test_view_data";
